...
$(document).ready(function() {
	...
	about = 'My name is Ashok Ostwal, an evolving Front End Developer.',
	...
	let list = "Ashok Ostwal : Hey there! For a list of available commands, type 'help'.";
	...
	function generateContactHTML() {
		...
		let linkedinLink = $('<a>LinkedIn</a>').attr({
			'href': 'https://www.linkedin.com/in/ashok-ostwal/',
			'target': '_blank'
		})
	...
	let shortBio = 'Student at MMDU,Mullana, majoring in Computer Science. Self-taught web developer, absolutely passionate about coding and the future of technology.';
